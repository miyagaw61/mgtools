...
#if test "$(hashdiff ${dstPath}/miyagawtools/ $HOME/miyagawtools/)"  = "False" ;then
	cecho -rfn '[+]'
	cecho -gf ${dstPath}'/miyagawtools/ -> '$HOME'/miyagawtools/'
	rsync -auv ${dstPath}/miyagawtools/*         $HOME/miyagawtools/
#fi
