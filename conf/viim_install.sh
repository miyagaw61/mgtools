#!/bin/sh
if test -e $HOME/repos/viim ;then
    rm -rf $HOME/repos/viim
fi
mkdir -p $HOME/viim
if test -e $HOME/repos/vim ;then
    rm -rf $HOME/repos/vim
fi
git clone https://github.com/vim/vim.git $HOME/repos/vim
cd $HOME/repos/vim
