...
cp -a $HOME/repos/mgtools/conf/rc/dein.toml $HOME/.deinvim
cp -a $HOME/repos/mgtools/conf/rc/dein_lazy.toml $HOME/.deinvim
cp -a $HOME/repos/mgtools/conf/rc/init.vim $HOME/.config/nvim
pyenv install 3.5.0
